...
class SubarrayDescription:
    ...
    def peek(self, ax=None):
        ...
        # This avoids a warning if users have e.g. "figure.constrained_layout" enabled
        # through their matplotlib config. Only call tight layout here if the layout engine
